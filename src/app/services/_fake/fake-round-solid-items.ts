...
export const _fakeTeams = [
    { id: 1001, name: 'Team Name Full #1', img: '/assets/img/_tmp/logo_team_1.png' },
    { id: 1002, name: 'Team Name Full #2', img: '/assets/img/_tmp/logo_team_2.png' },
    { id: 1003, name: 'Team Name Full #3', img: '/assets/img/_tmp/logo_team_3.png' },
    { id: 1004, name: 'Team Name Full #4', img: '/assets/img/_tmp/logo_team_4.png' }
];
...
export const _fakeGames = [
    {
        ...
        scoreHome: 2, scoreAway: 0, scoreAddHome: null, scoreAddAway: null, penaltiesHome: null, penaltiesAway: null
    },
    {
        id: 1002, date: new Date(2017, 3, 5, 18, 0, 10), round: _fakeRounds[0], home: _fakeTeams[2], away: _fakeTeams[3],
        scoreHome: 3, scoreAway: 3, scoreAddHome: null, scoreAddAway: null, penaltiesHome: null, penaltiesAway: null
    },
    {
        id: 1003, date: new Date(2017, 3, 6, 19, 0, 0), round: _fakeRounds[0], home: _fakeTeams[3], away: _fakeTeams[0],
        scoreHome: 1, scoreAway: 3, scoreAddHome: null, scoreAddAway: null, penaltiesHome: null, penaltiesAway: null
    },
    {
    ...
    },
    {
        ...
        scoreHome: 0, scoreAway: 0, scoreAddHome: null, scoreAddAway: null, penaltiesHome: null, penaltiesAway: null
    },
    {
        id: 1006, date: new Date(2017, 3, 14, 14, 0, 0), round: _fakeRounds[3], home: _fakeTeams[3], away: _fakeTeams[2],
        scoreHome: 2, scoreAway: 2, scoreAddHome: 0, scoreAddAway: 0, penaltiesHome: 3, penaltiesAway: 4
    },
    {
...
export const _fakeGamesDays = [
    { date: new Date(2017, 3, 5, 14, 30, 25), games: [_fakeGames[0], _fakeGames[1]] },
    { date: new Date(2017, 3, 6, 19, 0, 0), games: [_fakeGames[2]] },
    { date: new Date(2017, 3, 11, 19, 0, 0), games: [_fakeGames[3]] },
    { date: new Date(2017, 3, 14, 17, 0, 0), games: [_fakeGames[4]] },
    { date: new Date(2017, 3, 14, 17, 0, 0), games: [_fakeGames[5]] },
    { date: new Date(2017, 3, 16, 15, 0, 0), games: [_fakeGames[5]] },
    { date: new Date(2017, 3, 17, 15, 0, 0), games: [_fakeGames[6]] }
];
...
export const _fakeRoundsSolid = [
    ...
    ,
    {
        ...
        gamesDays: [_fakeGamesDays[5], _fakeGamesDays[5]]
    }
];
